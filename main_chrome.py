...
def init_driver():
    ...
    chromedriver = ('chromedriver.exe')  # path for a chromedriver
...
def get_data():
    ...
    time.sleep(1.5)
    driver.get(
        'https://esia.gosuslugi.ru/profile/rs/prns/?embed=(documents.elements,addresses.elements,vehicles.elements,kids.elements)')
